...
**Note**: Schema initially used DateTime64(3) for millisecond precision. **Superseded by [ADR-0021](/docs/architecture/decisions/0021-um-futures-support.md)** which upgraded to DateTime64(6) for microsecond precision to support Binance Vision API changes (effective January 1, 2025).
