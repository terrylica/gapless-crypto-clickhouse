...
**Acceptance Criteria**:
- [ ] Production validation workflow runs every 6 hours without manual intervention
- [ ] ClickHouse Cloud schema drift detected within 6 hours
- [ ] Binance CDN outages detected within 6 hours
- [ ] Write/read round-trip validates deduplication correctness
- [ ] `.github/workflows/ci.yml` deleted (no unit tests/linting)
- [ ] Documentation updated (CLAUDE.md + global workspace CLAUDE.md)
